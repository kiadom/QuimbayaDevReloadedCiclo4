    ...
    if(!queryLoading){
        ...
        return (
            <div className = "body-text">
                ...
                <h1>El proyecto no se puede editar por alguno de estos motivos: </h1>
                <h2>El usuario no lidera este proyecto</h2>
                <h2>El usuario no es administrador</h2>
                <h2>El proyecto está inactivo</h2>
            </div>
        );
    }
